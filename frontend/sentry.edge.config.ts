// Sentry edge-runtime init — no-op until @sentry/nextjs is installed + SENTRY_DSN is set.
// Next.js auto-loads this file in the edge runtime when present.
//
// Activate:
...
if (dsn) {
  import("@sentry/nextjs")
    ...
    .catch((err) => console.error("[sentry.edge] failed to load @sentry/nextjs:", err));
} else {
