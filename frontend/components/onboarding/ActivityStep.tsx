...
import { Armchair, Bike, Zap } from "lucide-react";
...
const OPTIONS = [
  { id: "sedentary", label: "Sedentar", description: "Muncă de birou, puțină mișcare", icon: Armchair },
  { id: "moderate", label: "Moderat", description: "Plimbări, sport ocazional", icon: Bike },
  { id: "active", label: "Activ", description: "Antrenuri regulate, viață activă", icon: Zap },
] as const;

export default function ActivityStep({ value, onChange, onNext }: ActivityStepProps) {
  return (
    <section className="mx-6 mt-4 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-zinc-900 text-center">Nivelul tău de activitate</h2>
      <p className="text-sm text-zinc-400 mt-1 text-center">Cât de activ ești în mod obișnuit?</p>
