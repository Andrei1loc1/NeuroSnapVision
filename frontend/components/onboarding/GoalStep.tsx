...
import { Heart, Battery, Trophy } from "lucide-react";
...
const OPTIONS = [
  { id: "longevity", label: "Longevitate", description: "Viață lungă și sănătoasă, dietă MIND", icon: Heart },
  { id: "energy", label: "Energie", description: "Vitalitate zilnică și somn odihnitor", icon: Battery },
  { id: "performance", label: "Performanță", description: "Putere maximă și recuperare rapidă", icon: Trophy },
] as const;
...
export default function GoalStep({ value, onChange, onNext }: GoalStepProps) {
  return (
    <section className="mx-6 mt-4 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-zinc-900 text-center">Obiectivul tău principal</h2>
      <p className="text-sm text-zinc-400 mt-1 text-center">Ce îți dorești cel mai mult?</p>
